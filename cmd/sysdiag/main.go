// sysdiag — comprehensive Linux system performance analyzer.
//
...
import (
	...
	diffpkg "github.com/baikal/sysdiag/internal/diff"
	"github.com/baikal/sysdiag/internal/ebpf"
	"github.com/baikal/sysdiag/internal/installer"
	"github.com/baikal/sysdiag/internal/model"
	"github.com/baikal/sysdiag/internal/orchestrator"
...
func main() {
	rootCmd := &cobra.Command{
		...
		Long: `sysdiag — single Go binary for Linux performance analysis.
...
Tier 3: Native eBPF (cilium/ebpf) — zero dependencies (needs root + kernel ≥ 4.15)`,
	...
	diffCmd := &cobra.Command{
		...
		Short: "Compare two sysdiag reports",
